...
public function searchByTitle(Request $request)
{
    ...
    {
        $sportResources = DigitalMedia::where('category', 'Sport')->get();
    ...
    {
        $financeResources = DigitalMedia::where('category', 'Finance')->get();

        if ($financeResources->isNotEmpty()) {
            return response()->json([
                'message' => 'Get finance resource',
                'total' => $financeResources->count(),
                'data' => $financeResources
            ], 200);
        }
